 ...
 * @subpackage Mark_Media_Plugin/admin
 */
...
class Mark_Media_Plugin_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/mark-media-plugin-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/mark-media-plugin-admin.js', array( 'jquery' ), $this->version, false );
